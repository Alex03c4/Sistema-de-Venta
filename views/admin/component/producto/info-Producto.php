<div class="col-span-6 sm:col-span-4 m-5 ">
    ...
    <div class="flex justify-between">
        ...
        <input type="text" name="nombre" autocomplete="off" id="nombre" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>
</div>
...
<div class="col-span-6 sm:col-span-4 m-5 ">
    ...
    <div class="flex justify-between">
        ...
        <input type="text" name="marca" autocomplete="off" id="marca" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>
</div>
...
<div class="col-span-6 sm:col-span-4 m-5 ">
    ...
    <div class="flex justify-between">
        ...
        <input type="number" name="stock" autocomplete="off" id="stock" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>
</div>
