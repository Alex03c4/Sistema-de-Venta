...
<div class="ml-16 mt-4 mr-3 lg:ml-64 ">
  <div class="bg-green-500 text-white text-lg font-semibold transition-colors  shadow-lg rounded-2xl flex justify-between p-2">
    <div>
      <h2>Lista de Producto Minorista</h2>
    </div>
          ...
          <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <table id="Table" class="min-w-full divide-y divide-gray-200">
              ...
              <tbody id="tbody" class="bg-white divide-y divide-gray-200">
                ...
                <?php
                if (isset($data['xUnidad'])) {

                  foreach ($data['xUnidad'] as $key => $value) { ?>
                        ...
                        <div class="flex items-center">
                          <div class="flex-shrink-0 h-10 w-10">
                            ...
                            if (isset($data['img'])) {
                              foreach ($data['img'] as $imagen => $resultado) {
                                if ($resultado->img_id === $data['producto'][$value->id_producto]) {
                          ...
                          <div class="ml-4">
                            <div class="text-sm font-medium text-gray-900">
                              <?php echo $data['producto'][$value->id_producto] ?>
                            </div>
