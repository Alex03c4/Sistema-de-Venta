...
<div class="col-span-6 sm:col-span-4 m-5 ">
    ...
    <div class="flex justify-between">
        ...
        <input value="<?php echo $data['producto']['precio']; ?>" type="number" name="precio" autocomplete="off" id="precio" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>
</div>
