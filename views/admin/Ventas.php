...
<div class="ml-16 mt-4 mr-3  ">
  ...
  <form role="form" name="crear-ventas" class="Carrito" pagina="crear-ventas.php" method="post" action="index.php?controllers=Venta&a=GenerarVentas" location="index.php?controllers=Venta&a=ViewVentas">
