...
<div class="ml-16 mt-4 mr-3 lg:ml-64 ">
  <div class="bg-white  overflow-hidden  shadow-lg rounded-2xl p-4  dark:bg-gray-700 w-full ">
    <form name="login-perfil-form" id="Updates-perfil" class="Updates" method="post" action="index.php?controllers=Perfil&a=updateAdmin" enctype="multipart/form-data">
      ...
      <div class="grid grid-cols-1 gap-y-5 gap-x-5 lg:grid-cols-2">
        ...
        <div class="bg-gray-100  rounded-2xl gap-y-5">
          ...
          <div>
            <?php require_once 'views\admin\component\User\edid-User.php'; ?>
          </div>
        </div>
        ...
        <div class="bg-gray-100  rounded-2xl gap-y-5">
          ...
          <div>
            <?php require_once 'views\admin\component\User\edid-roles.php'; ?>
            </div>
          </div>

        </div>
        <div class="px-4 py-3  text-right sm:px-6">
          <input type="hidden" name="id" value="<?php echo $data['profiles']['id'];?>">
